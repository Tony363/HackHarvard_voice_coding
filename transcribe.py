...
def draw_uml(
    ...
    args = shlex.split(f'-o png -p example {filename}')
...
def main():
    ...
    parser.add_argument(
        'audio_file', help='url to file or local audio filename')
    parser.add_argument('--local', action='store_true',
                        help='must be set if audio_file is a local filename')
...
if __name__ == '__main__':
    """
    export AAI_API_KEY=50e2ab13db6d43e39e8f2d0e9b5533c7
    set AAI_API_KEY=50e2ab13db6d43e39e8f2d0e9b5533c7
